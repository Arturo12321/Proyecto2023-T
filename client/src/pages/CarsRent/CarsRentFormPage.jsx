                    ...
                    <div className="form-group col-lg-4">
                      ...
                      <div  className="col-sm-12 text-right">
                          <div className="panel-body buttons-margin">
                              ...
                              <Link className="btn btn-w-md btn-warning" to="/my-cars-rent">Cancelar</Link>
                          </div>
                      </div>    
                    </form>
                  </div>
...
export default CarsRentFormPage